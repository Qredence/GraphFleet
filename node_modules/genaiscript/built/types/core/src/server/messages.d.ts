...
import { ParsePdfResponse, ResponseStatus, RetrievalSearchOptions, RetrievalSearchResponse, RetrievalUpsertOptions as RetrievalVectorUpsertOptions } from "../host";
...
export type RequestMessages = ServerKill | ServerVersion | ServerEnv | RetrievalVectorClear | RetrievalVectorUpsert | RetrievalSearch | ServerVersion | ParsePdfMessage | PromptScriptTestRun | ModelsPull | ShellExec | PromptScriptStart | PromptScriptAbort;
export type ResponseEvents = PromptScriptProgressResponseEvent | PromptScriptEndResponseEvent;
