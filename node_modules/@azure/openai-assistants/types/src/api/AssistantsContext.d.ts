...
export declare function createAssistants(endpoint: string, credential: KeyCredential | TokenCredential, options?: AssistantsClientOptions): AssistantsContext;
//# sourceMappingURL=AssistantsContext.d.ts.map